...
void StatusBarSettingsActivity::handleSelection() {
  switch (selectedIndex) {
    case ITEM_CHAPTER_PAGE_COUNT:
      ...
      break;
    case ITEM_PAGE_COUNT_SCOPE:
      SETTINGS.statusBarPageCountScope =
          (SETTINGS.statusBarPageCountScope + 1) % CrossPointSettings::PAGE_COUNT_SCOPE_COUNT;
      break;
  ...
  GUI.drawList(
      ...
      [](int index) -> std::string {
        switch (index) {
          ...
          case ITEM_PAGE_COUNT_SCOPE:
            return SETTINGS.statusBarPageCountScope == CrossPointSettings::PAGE_COUNT_BOOK ? tr(STR_BOOK)
                                                                                           : tr(STR_CHAPTER);
          case ITEM_BOOK_PROGRESS_PERCENTAGE:
