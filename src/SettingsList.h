    ...
    std::vector<SettingInfo> v = {
        ...
        SettingInfo::Enum(
            ...
            {StrId::STR_DARK, StrId::STR_LIGHT, StrId::STR_CUSTOM, StrId::STR_COVER, StrId::STR_NONE_OPT,
             StrId::STR_COVER_CUSTOM, StrId::STR_QUICK_RESUME, StrId::STR_FRONTISPIECE, StrId::STR_DASHBOARD},
        ...
        SettingInfo::Toggle(StrId::STR_SLEEP_INFO_PANE, &CrossPointSettings::sleepInfoPane, "sleepInfoPane",
                            StrId::STR_CAT_DISPLAY),
        SettingInfo::Enum(StrId::STR_SLEEP_INFO_CONTENT, &CrossPointSettings::sleepInfoContent,
                          {StrId::STR_PAGES, StrId::STR_TIME, StrId::STR_BOTH}, "sleepInfoContent",
                          StrId::STR_CAT_DISPLAY),
        SettingInfo::Enum(StrId::STR_SLEEP_INFO_REFERENCE, &CrossPointSettings::sleepInfoReference,
                          {StrId::STR_CHAPTER, StrId::STR_BOOK}, "sleepInfoReference", StrId::STR_CAT_DISPLAY),
        SettingInfo::Enum(StrId::STR_SLEEP_INFO_SECONDARY, &CrossPointSettings::sleepInfoSecondary,
                          {StrId::STR_AUTHOR, StrId::STR_CHAPTER}, "sleepInfoSecondary", StrId::STR_CAT_DISPLAY),
        SettingInfo::Enum(StrId::STR_SLEEP_INFO_POSITION, &CrossPointSettings::sleepInfoPanePosition,
                          {StrId::STR_BOTTOM, StrId::STR_TOP}, "sleepInfoPanePosition", StrId::STR_CAT_DISPLAY),
        ...
        SettingInfo::Enum(StrId::STR_TIME_LEFT, &CrossPointSettings::statusBarTimeLeft,
                          {StrId::STR_STATE_OFF, StrId::STR_CHAPTER, StrId::STR_BOOK}, "statusBarTimeLeft",
                          StrId::STR_CUSTOMISE_STATUS_BAR),
