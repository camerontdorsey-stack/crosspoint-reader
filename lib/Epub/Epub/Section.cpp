...
void Section::writeSectionFileHeader(const int fontId, const float lineCompression, const bool extraParagraphSpacing,
                                     ...
                                     const bool orphanControl, const bool embeddedStyle, const uint8_t imageRendering,
  ...
  static_assert(HEADER_SIZE == sizeof(SECTION_FILE_VERSION) + sizeof(fontId) + sizeof(lineCompression) +
                                   ...
                                   sizeof(orphanControl) + sizeof(embeddedStyle) + sizeof(imageRendering) +
  ...
  serialization::writePod(file, orphanControl);
...
bool Section::loadSectionFile(const int fontId, const float lineCompression, const bool extraParagraphSpacing,
  ...
  // Match parameters
  {
    ...
    serialization::readPod(file, fileOrphanControl);
    ...
    if (fontId != fileFontId || lineCompression != fileLineCompression ||
        ...
        hyphenationEnabled != fileHyphenationEnabled || orphanControl != fileOrphanControl ||
...
bool Section::createSectionFile(const int fontId, const float lineCompression, const bool extraParagraphSpacing,
  ...
  writeSectionFileHeader(fontId, lineCompression, extraParagraphSpacing, paragraphAlignment, viewportWidth,
                         viewportHeight, hyphenationEnabled, orphanControl, embeddedStyle, imageRendering,
                         focusReadingEnabled);
  ...
  ChapterHtmlSlimParser visitor(
      ...
      viewportHeight, hyphenationEnabled, orphanControl, focusReadingEnabled,
